 ...
 */
public class ZoneRelateSceneAdapter extends BaseAdapter {
...
//    private List<IndexUserListBean.DataBean.UsersBean> userList;//插入情景列表
    ...
    public ZoneRelateSceneAdapter(Activity activity, List<SceneList.DataBean.RowsBean> sceneList) {
...
//        this.userList = userList;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(parent.getContext(), R.layout.item_relate_zone, null);
...
//    }
    ...
    class UserAdapter extends RecyclerView.Adapter<UserAdapter.VH> implements View.OnClickListener {
        private Activity activity;
        private ZoneRelateSceneAdapter indexQJListAdapter;
        private List<IndexUserListBean.DataBean.UsersBean> userList;
        private WaittingDialog dialog;

        public UserAdapter(Activity activity, ZoneRelateSceneAdapter indexQJListAdapter, List<IndexUserListBean.DataBean.UsersBean> userList) {
            this.activity = activity;
