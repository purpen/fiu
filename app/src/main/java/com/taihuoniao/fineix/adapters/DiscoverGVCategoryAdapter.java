...
/**
 * @author lilin    发现分类项（三列）
 */
public class DiscoverGVCategoryAdapter extends CommonBaseAdapter<DiscoverBean.ProCategoryBean> {
    public DiscoverGVCategoryAdapter(List<DiscoverBean.ProCategoryBean> list, Activity activity) {
        super(list, activity);
    }
