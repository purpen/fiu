 ...
 */
public class NewProductAdapter extends CommonBaseAdapter<DataChooseSubject.ItemChoosenSubject> {
    public NewProductAdapter(ArrayList list, Activity activity) {
        super(list, activity);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = Util.inflateView(R.layout.item_new_product, null);
