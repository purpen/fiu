 ...
 */
public class ChooseSubjectActivity extends BaseActivity<ItemQJCollect> {
    ...
    protected void initView() {
        custom_head.setHeadCenterTxtShow(true, "精选主题");
        String[] array = getResources().getStringArray(R.array.subject_tab);
