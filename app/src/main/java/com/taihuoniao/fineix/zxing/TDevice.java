package com.taihuoniao.fineix.zxing;
...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) MainApplication.getContext().getSystemService(
...
//    }
    ...
    public static void hideSoftKeyboard(View view) {
        if (view == null)
            return;
        ((InputMethodManager) MainApplication.getContext().getSystemService(
    ...
    public static String getCurCountryLan() {
        return MainApplication.getContext().getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + MainApplication.getContext().getResources().getConfiguration().locale
                .getCountry();
    }
    ...
    public static int getVersionCode() {
        ...
        try {
            versionCode = MainApplication.getContext()
                    .getPackageManager()
                    .getPackageInfo(MainApplication.getContext().getPackageName(),
                            0).versionCode;
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) MainApplication.getContext()
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = MainApplication.getContext().getPackageManager()
...
//    }
    ...
    public static void copyTextToBoard(String string) {
        if (TextUtils.isEmpty(string))
            return;
        ClipboardManager clip = (ClipboardManager) MainApplication.getContext()
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = MainApplication.getContext().getResources()
                    .getDimensionPixelSize(x);
