 ...
 */
public class SearchQJFragment extends SearchFragment {
    private String q;
    ...
    private void search() {
        RequestParams params = ClientDiscoverAPI.getsearchRequestParams(q, "9", null, page + "", "8", isContent ? "content" : "tag", null);
