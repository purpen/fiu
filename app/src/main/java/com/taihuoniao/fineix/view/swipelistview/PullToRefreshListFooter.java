package com.taihuoniao.fineix.view.swipelistview;
...
public class PullToRefreshListFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.xlistview_footer1, null);
        addView(moreView);
