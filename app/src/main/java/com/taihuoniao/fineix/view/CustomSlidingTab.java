...
public class CustomSlidingTab extends HorizontalScrollView {
    ...
    public CustomSlidingTab(Context context, AttributeSet attrs) {
    ...
    public CustomSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        shouldExpand = a.getBoolean(R.styleable.CustomSlidingTab_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.CustomSlidingTab_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.CustomSlidingTab_pstsTextAllCaps, textAllCaps);
