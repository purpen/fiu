...
public class ClipSquareImageView extends AppCompatImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public ClipSquareImageView(Context context) {
        this(context, null);
    }
    ...
    public ClipSquareImageView(Context context, AttributeSet attrs) {
        ...
        setBorderDistance((int) a.getDimension(R.styleable.ClipSquareImageView_ClipSquareIV_BorderDistance, 0));
        setBorderWidth((int) a.getDimension(R.styleable.ClipSquareImageView_ClipSquareIV_BorderWidth, 1));
