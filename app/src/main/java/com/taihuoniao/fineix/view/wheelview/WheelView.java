...
package com.taihuoniao.fineix.view.wheelview;
...
public class WheelView extends View {
	/** Scrolling duration */
	private static final int SCROLLING_DURATION = 5;
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFF, 0x00AAAAAA, 0x00AAAAAA };

	/** Additional items height (is added to standard text item height) */
	private static final int ADDITIONAL_ITEM_HEIGHT = 40;

	/** Text size */
	private static final int TEXT_SIZE_SEL = 40;
	private static final int TEXT_SIZE_NOSEL = 36;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(TEXT_SIZE_NOSEL);
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(TEXT_SIZE_SEL);
