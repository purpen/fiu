...
//        StatusBarChange.initWindow(SelectAddressActivity.this);
...
//                startActivity(new Intent(SelectAddressActivity.this, AddNewAddressActivity.class));
                break;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DataConstants.DELETE_ADDRESS:
                    ...
                    if (success) {
                        Toast.makeText(SelectAddressActivity.this, R.string.delete_success, Toast.LENGTH_SHORT).show();
                        list.clear();
                        currentPage = 1;
                        dialog.show();
                        DataPaser.getAddressList(currentPage + "", mHandler);
