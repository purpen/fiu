...
//        titleLayout.setTitle(R.string.comment,getResources().getColor(R.color.black333333));
...
//        titleLayout = (GlobalTitleLayout) findViewById(R.id.activity_commentlists_titlelayout);
